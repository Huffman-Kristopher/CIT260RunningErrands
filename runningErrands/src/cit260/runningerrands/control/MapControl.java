...
public class MapControl {
    ...
    public static void assignObjectivesToScenes() {
        ...
        scenes[LocationName.startingScene.ordinal()].setNpc(npc[NPCList.adolf.ordinal()]);
        scenes[LocationName.mallScene.ordinal()].setNpc(npc[NPCList.shamWowGuy.ordinal()]);
        scenes[LocationName.GroceryScene.ordinal()].setNpc(npc[NPCList.crazyCatLady.ordinal()]);
        scenes[LocationName.gasScene.ordinal()].setNpc(npc[NPCList.zeus.ordinal()]);
        scenes[LocationName.gunShopScene.ordinal()].setNpc(npc[NPCList.shopkeeper.ordinal()]);
        scenes[LocationName.sportingScene.ordinal()].setNpc(npc[NPCList.dracula.ordinal()]);
        scenes[LocationName.libraryScene.ordinal()].setNpc(npc[NPCList.hannibal.ordinal()]);
        scenes[LocationName.churchScene.ordinal()].setNpc(npc[NPCList.priest.ordinal()]);
        scenes[LocationName.hospitalScene.ordinal()].setNpc(npc[NPCList.vlad.ordinal()]);
        scenes[LocationName.schoolScene.ordinal()].setNpc(npc[NPCList.principal.ordinal()]);
        scenes[LocationName.bankScene.ordinal()].setNpc(npc[NPCList.babyFace.ordinal()]);
        scenes[LocationName.comicScene.ordinal()].setNpc(npc[NPCList.wizard.ordinal()]);
        scenes[LocationName.repairScene.ordinal()].setNpc(npc[NPCList.nikolai.ordinal()]);
        scenes[LocationName.ninjaScene.ordinal()].setNpc(npc[NPCList.ninja.ordinal()]);
        scenes[LocationName.armyScene.ordinal()].setNpc(npc[NPCList.soldier.ordinal()]);
        scenes[LocationName.postScene.ordinal()].setNpc(npc[NPCList.khan.ordinal()]);
        scenes[LocationName.fireworksScene.ordinal()].setNpc(npc[NPCList.jimbob.ordinal()]);
        scenes[LocationName.petScene.ordinal()].setNpc(npc[NPCList.nsync.ordinal()]);
        scenes[LocationName.MarinaScene.ordinal()].setNpc(npc[NPCList.pirate.ordinal()]);
        scenes[LocationName.improvementScene.ordinal()].setNpc(npc[NPCList.plagueMonkey.ordinal()]);
        scenes[LocationName.policeScene.ordinal()].setNpc(npc[NPCList.officer.ordinal()]);
        scenes[LocationName.zooScene.ordinal()].setNpc(npc[NPCList.giraffe.ordinal()]);
        scenes[LocationName.museumScene.ordinal()].setNpc(npc[NPCList.docent.ordinal()]);
        scenes[LocationName.cemeteryScene.ordinal()].setNpc(npc[NPCList.ghost.ordinal()]);
        scenes[LocationName.volcanoScene.ordinal()].setNpc(npc[NPCList.joe.ordinal()]);
        scenes[LocationName.pizzaScene.ordinal()].setNpc(npc[NPCList.godfather.ordinal()]);
        scenes[LocationName.orphanScene.ordinal()].setNpc(npc[NPCList.orphan.ordinal()]);
        scenes[LocationName.asylumScene.ordinal()].setNpc(npc[NPCList.doctor.ordinal()]);
        scenes[LocationName.accountantScene.ordinal()].setNpc(npc[NPCList.sergy.ordinal()]);
        scenes[LocationName.redBoxScene.ordinal()].setNpc(npc[NPCList.ceasar.ordinal()]);
