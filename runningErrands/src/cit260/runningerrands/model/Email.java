...
public enum Email implements Serializable {
    ...
    EmptyFridge("Warning SmartFridge has detected the following issues; You are low on the things required to keep you alive! MOUNTAIN DEW, DR. PEPPER, and BREAD!!! Don’t die go get your food."),
    ...
    BankJob("It’s Nikolai, we're just waiting for you. You didn’t forget did you? Get your stuff together and meet us at the bank."),
